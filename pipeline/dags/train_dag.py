...
def train_model():
    ...
    model.fit([X_audio_train, X_frame_train], Y_train, epochs=n_epochs, validation_data=([X_audio_test, X_frame_test], Y_test))
...
with DAG(
    "train_complete_model", start_date=datetime(2024, 11, 15), schedule_interval=None
) as dag:
